...
**P1 已完成計算器**:
- 趨勢類：WMA, HMA, Aroon, Parabolic SAR, Supertrend
- 動能類：ROC, Momentum, Williams %R, CCI, MFI, Stochastic RSI
- 波動類：Donchian Channel, Keltner Channel
- 成交量類：AD Line, CMF
- 支撐壓力類：Pivot Points, Fibonacci Retracement
- 統計類：Linear Regression（含 Slope, R²）

> 詳細開發記錄請參閱 [M07-開發記錄](../../design/M07-開發記錄.md)
